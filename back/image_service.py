...
def get_image_checksum(image):
    ...
    # Calculate checksum of target_image
    img_bytes = image.tobytes()
    checksum = hex(hash(img_bytes) & 0xFFFFFFFFFFFFFFFF)[2:].zfill(16)

    return checksum

def create_epoch_image(input_image, input_mask, inferred_image, target_image, epoch, output_path):
    """
    ...
    # _, _, text_width, text_height = font.getbbox(text, font)
    ...
    checksum = get_image_checksum(target_image)
    image_path = output_path + checksum + ".png"
